...
public class UserPreferences {
    ...
    @SerializedName("preferred_languages") private List<String> preferredLanguages;
    @SerializedName("liked_genres") private List<String> likedGenres;
    @SerializedName("liked_authors") private List<String> likedAuthors;
    @SerializedName("liked_book_ids") private List<String> likedBookIds;
    @SerializedName("disliked_genres") private List<String> dislikedGenres;
    @SerializedName("disliked_authors") private List<String> dislikedAuthors;
    @SerializedName("disliked_book_ids") private List<String> dislikedBookIds;
